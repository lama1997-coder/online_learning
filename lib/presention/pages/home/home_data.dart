...
class HomeData {
  final List<CourseOverviewModel> courseOverview = [
    CourseOverviewModel(
        subtitle: '',
        title: 'What do you\nwant to learn\n today ?',
        image: Images.overview1,color:ThemeDataProvider.blueLightColor),
         CourseOverviewModel(
        subtitle: '',
        title: 'What do you\nwant to learn\n today ?',
        image: Images.overview2,color: ThemeDataProvider.greenLightColor)
  ];

  final List<LearningPlanModel> learningPlan = [
    LearningPlanModel(name: 'Packaging Design', total: '48', complate: '40',
