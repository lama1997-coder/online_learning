...
class Progress extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      decoration: BoxDecoration(color: ThemeDataProvider.borderColor,borderRadius: BorderRadius.circular(22)),
        ),
        Container(
          height: 10,
...
class GradientBorderCircularProgressIndicator extends StatelessWidget {
  ...
  const GradientBorderCircularProgressIndicator({super.key, 
    required this.strokeWidth,
    required this.size,
    required this.colors, required this.value,
  });
      ...
      children: [
        ...
        SizedBox(
          ...
          child: CircularProgressIndicator(
            strokeWidth: 10.0,
            valueColor:
                const AlwaysStoppedAnimation<Color>(ThemeDataProvider.borderColor),
            value: value,
          ),
        ),
      ],
